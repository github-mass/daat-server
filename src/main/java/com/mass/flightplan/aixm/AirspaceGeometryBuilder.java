...
//        GeometryFactory gf = JTSFactoryFinder.getGeometryFactory();
        ...
        /*
            ...
            Code should be able to handle it fine and would return empty LineString.
         */
        if (vertices.size() == 1 && "Circle".equals(vertices.get(0).getNodeName())) {
            ...
            var geom = points.size() < 3
                ? gf.createLineString(points.toArray(Coordinate[]::new))
                : gf.createPolygon(points.toArray(Coordinate[]::new));
