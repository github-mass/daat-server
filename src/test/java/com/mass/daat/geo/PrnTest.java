...
import com.mass.daat.db.DaatDbConfig;
...
import com.mass.daat.model.aixm.AirspaceExtractor;
import com.mass.daat.model.aixm.AirspaceType;
...
@SpringBootTest(classes = {ApplicationConfiguration.class, DaatDbConfig.class, PrnTest.Cfg.class})
