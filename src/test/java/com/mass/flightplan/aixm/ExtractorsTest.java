...
public class ExtractorsTest {
    ...
    public void loadDocument()
        throws IOException
    {
        Path aixmlFile = Path.of("aixm/export_xml_bd_sia_2023-04-20-p2/AIXM4.5_all_FR_OM_2023-04-20.xml");
    ...
    {
        XPathDocumentExtractor dex = XPathDocumentExtractor.from(Path.of("aixm/export_xml_bd_sia_2023-04-20-p2/XML_SIA_2023-04-20.xml")).build();
